...
export function DashboardHero({ headline, support, focusCard }: DashboardHeroProps) {
  return (
    <section className="grid gap-6 rounded-[1.35rem] border border-white/10 bg-[linear-gradient(135deg,rgba(234,179,8,0.14),rgba(46,46,46,0.34))] p-6 shadow-glow lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:p-8">
      ...
      {focusCard ?? (
        <CurrentFocusCard
          ...
          courseLabel="Active course"
          currentFocusLabel="Current focus"
          courseProgressLabel="Course progress"
          courseTitle="--"
          courseThumbnail="/ak-hero.png.png"
          focusText="Keep your learning momentum going."
          progressPercent={0}
          actionHref="/courses"
